namespace OpenRegion71Bot
{
    class ConfidentialData
    {
        ...
        public class OpenRegion71
        {
            ...
            public static string ExecutorsStructurePages { get => "https://or71.ru/bitrix/admin/iblock_section_admin.php?IBLOCK_ID=232&type=messages&lang=ru&find_section_section=0&SIZEN_1=1000&PAGEN_1="; }
            ...
            public static string SourceCategoryPages { get => "https://or71.ru/bitrix/admin/iblock_section_admin.php?IBLOCK_ID=96&type=information&lang=ru&find_section_section=0&SIZEN_1=1000&PAGEN_1="; }
            public static string SourcePages { get => "https://or71.ru/bitrix/admin/iblock_element_admin.php?IBLOCK_ID=96&type=information&lang=ru&SIZEN_1=1000&PAGEN_1=1&find_section_section="; }
            public class Api
            {
                ...
                public static string Problem { get => "https://or71.ru/api.php?action=getissue&" + Key; }
            }
        }
    }
}
